...
import LoginSite from "src/App/Login/LoginSite";
...
import { SignUp } from './Registration/Registrieren';

export default function Routes() {
  return (
    <Switch>
      <Route path="/registrierung" exact={true} component={SignUp} />
      <Route path="/" exact={true} component={Body} />
      <Route path="/login" exact={true} component={LoginSite} />
